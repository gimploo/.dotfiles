...
require("lazy").setup({
  ...
  { -- Autoformat
...

	{
      ...
      highlights = {
				-- Controls the color of the active/focused buffer tab
				buffer_selected = {
					bold = true,
					italic = false,
				},
				-- Controls the color of the vertical indicator line on the active buffer
				indicator_selected = {
  ...
  { 'nvim-focus/focus.nvim', version = '*', enabled = true, 
    opts = {
      ui = {
            cursorline = true,
            signcolumn = true,
...
-- Move the actual window/pane position
vim.keymap.set("n", "<leader>H", "<C-w>H", { desc = "Move window to the far left" })
vim.keymap.set("n", "<leader>L", "<C-w>L", { desc = "Move window to the far right" })
